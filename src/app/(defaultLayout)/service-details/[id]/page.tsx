...
function ServiceDetails() {
  ...
  console.log(servicesData?.data?.serviceList);
  return (
    <div>
      <div className="flex py-20 flex-col gap-6 lg:flex-row container">
        <div className="lg:w-1/2 flex flex-col gap-4">
          ...
          <ul className="text-[#494949] text-[16px] font-normal leading-[160%]">
            {servicesData?.data?.serviceList[0] !== "" &&
          ...
          <p className="text-[#3D3D3D] text-2xl font-semibold leading-[140%]">
            {servicesData?.data?.duration}min/ £{servicesData?.data?.price}
          </p>
        </div>
