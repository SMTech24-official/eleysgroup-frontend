    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10 container mx-auto px-4">
        <div className="flex flex-col items-center justify-center min-h-screen text-center text-white pt-16">
          ...
          <p className="text-lg md:text-xl max-w-2xl mb-8 text-gray-200">{description}</p>
          <Link className="md:hidden" href={"/book-appointment"}>
            <Button size="lg" className="bg-primary text-foreground hover:bg-primary px-4 py-2">
              Book Appointment
            </Button>
          </Link>
        </div>
