...
import { getDate, getDay, getStartOrEndTime } from "@/lib/formatDates";
...
const BookComponent = () => {
  ...
  return (
    <div className="my-10">
                          ...
                          <div>
                            <div className="flex items-center  gap-5">
                              <p className="text-[#04090D] text-lg font-medium leading-[150%]">
                                {" "}
                                {item?.slots[0]?.startDateTime &&
                                  getDate(item?.slots[0]?.startDateTime) + "-" + getDay(item?.slots[0]?.startDateTime)}
                              </p>
      ...
      <div>
        {showBookingForm && <BookingForm selectedslot={selectedslot} setShowBookingForm={setShowBookingForm} />}
      </div>
    </div>
  );
};
